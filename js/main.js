...
class SceneGame extends Phaser.Scene {
    ...
    create ()
    {
        ...
        room1 =  this.physics.add.staticSprite(this.scale.width / 2, this.scale.height / 2, 'room');
...
class SceneUI extends Phaser.Scene {
    ...
    create ()
    {
        ...
        /////////////////////////////////////////////////////////////////////////////////////////
        optionsGroup = this.physics.add.staticGroup();
        this.physics.add.collider(optionsGroup, room1);
        ////////////////////////////////////////////////////////////////////////////////////////////
        ...
        ///////////////////////////////////////////////////////////////////
        // курсорпоинтер
        hand = this.physics.add.sprite(this.scale.width / 2, this.scale.height * 1.5, 'hand');
        // this.physics.add.collider(hand, room1);
        ...
        option.forEach(element => {
            ...
            //     // this.physics.add.collider(element, hand, hitBomb);
            //         this.physics.add.overlap(element, hand, hitBomb, null, this);
            ...
            //     function hitBomb (element, hand)
            //     {
            //         // console.log(element.body.touching)
            //         // console.log(element)
            //         // option.setTint(0xff0000);
            //         // element.setScale(1.5);
            //         // element.body.touching.none ? 0x0099ff : 0xff9900;
            //         if (!element.body.touching.none) {
            //             console.log(element) 
            //             element.setScale(1.5);
            //         }
            //         else {
